...
export const en: Record<MessageKey, MessageValue> = {
  ...
  'app.analysisCount': 'Issues {count}',
  ...
  'app.refresh': 'Rescan',
  'app.refreshOptions': 'Scan options',
  'app.refreshHint': 'Scan skills and projects on disk (fast)',
  'app.deepRefresh': 'Deep scan',
  'app.deepRefreshHint': 'Also query the skills CLI for agent declarations and links (slower)',
  'app.updateAll': 'Update all',
  'app.evaluate': 'Evaluate skills',
  'app.evaluateHint': 'Configure a model in Settings first',
  'app.evaluating': 'Evaluating…',
  ...
  'confirm.reevaluate.title': 'Re-evaluate',
  'confirm.reevaluate.body': 'This overwrites the evaluation generated {time}. Re-evaluate?',
  'confirm.reevaluate.confirm': 'Re-evaluate',
  ...
  // ---- skill list ----
  'skillList.empty': 'No skills in this location yet',
  ...
  // ---- analysis view ----
  'analysis.severity.error': 'Errors',
  'analysis.severity.warn': 'Warnings',
  'analysis.severity.info': 'Info',
  'analysis.all': 'All {count}',
  'analysis.deterministic': 'Deterministic',
  'analysis.heuristic': 'Heuristic',
  'analysis.similarity': 'Similarity {value}%',
  'analysis.detailHeading': 'Details',
  'analysis.suggestionHeading': 'Suggestion',
  'analysis.evidenceHeading': 'Evidence',
  'analysis.skillsHeading': 'Related skills',
  'analysis.emptyLevel': 'No findings at this level',
  'analysis.selectHint': 'Select a finding to see its details',
  'analysis.skillScope': '{name} ({scope})',
  'analysis.aiEmpty': 'Not evaluated yet. Click “Evaluate skills” in the toolbar to start.',
  'analysis.aiEvaluating': 'Evaluating…',
  'analysis.aiOverview': 'Evaluation overview',
  'analysis.aiSummary': 'Evaluation summary',
  'analysis.aiAverage': 'Average score',
  'analysis.aiScores': 'Scores ({count})',
  'analysis.aiStale': 'Skill content changed; consider re-evaluating.',
  'analysis.verdictsStale': 'Skill content changed; AI verdicts may be stale.',
  'analysis.aiLocaleMismatch': 'The report language differs from the UI; consider re-evaluating.',
  'analysis.aiGeneratedAt': 'Generated {time} · {model}',
  'analysis.aiStrengths': 'Strengths',
  'analysis.aiSkillIssues': 'Issues',
  'analysis.aiKind.duplicate': 'Duplicate',
  'analysis.aiKind.conflict': 'Conflict',
  'analysis.aiKind.quality': 'Quality',
  'analysis.aiKind.trigger': 'Trigger',
  'analysis.aiKind.boundary': 'Boundary',
  'analysis.aiProcess': 'Process',
  'analysis.aiThinking': 'Reasoning',
  'analysis.aiNote': 'AI verdict',
  'analysis.aiVerdict.confirmed': 'AI confirmed',
  'analysis.aiVerdict.false-positive': 'Possible false positive',
  'analysis.aiVerdict.uncertain': 'AI uncertain',
  'analysis.confidence.ai': 'AI',
  'analysis.hideFalsePositives': 'Hide AI false positives',
  'analysis.verdictsAt': 'AI reviewed {time}',

  // ---- evaluation process steps ----
  'eval.step.prepare': 'Preparing to evaluate {count} skills',
  'eval.step.scoring': 'Scoring batch {index}/{total}: {names}',
  'eval.step.pairs': 'Found {count} duplication/conflict candidates',
  'eval.step.judging': 'Judging candidate pairs',
  'eval.step.summary': 'Writing the overview',
  'eval.step.review': 'Reviewing {count} candidate pairs',
  ...
  'search.detailInstall': 'Install command',
  'search.detailDescription': 'Description',
  'search.detailFiles': { one: 'Files ({count})', other: 'Files ({count})' },
  ...
  'settings.category.scanning': 'Scanning',
  ...
  'settings.llmEnable': 'Enable language model',
