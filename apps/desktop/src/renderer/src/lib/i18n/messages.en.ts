...
export const en: Record<MessageKey, MessageValue> = {
  ...
  'confirm.install.body':
    'Install {package} into the checked locations and link all skills to all agents.',
  'confirm.install.scopeLabel': 'Install location',
  'confirm.install.scopeGlobal': 'Global',
  'confirm.install.scopeGlobalHint': 'Home directory (available across all projects)',
  'confirm.install.scopeProject': 'Projects',
  'confirm.install.scopeProjectHint': 'Multi-select; install into several projects',
  'confirm.install.scopeProjectUnavailable': 'No projects yet — add one from the sidebar',
  'confirm.install.noTargets': 'Select at least one project.',
  ...
  'search.resultsSummary': {
    one: '{n} result for “{query}”',
    other: '{n} results for “{query}”',
  },
  'search.sourceNote': 'Public index from skills.sh',
  'search.tabAllTime': 'All Time',
  'search.tabTrending': 'Trending (24h)',
  'search.tabHot': 'Hot',
  'search.loading': 'Loading…',
  'search.refresh': 'Refresh leaderboard',
  'search.clearSearch': 'Back to leaderboard',
  'search.official': 'Official',
  'search.installsLabel': 'Installs',
  ...
  'settings.llmHeading': 'Language model',
  'settings.llmHint':
    'SkillCat does not bundle a model. Enter your own API key; it is stored only in the local config.json and never uploaded.',
  ...
  'settings.llmNoKey': 'No API key needed',
  'settings.llmTest': 'Test connection',
  'settings.llmTesting': 'Testing…',
  'settings.llmTestOk': 'Connected · {model}',
  'settings.llmTestFail': 'Failed ({status})',
  ...
  'settings.llmProvider.qwen': 'Qwen (Alibaba)',
  'settings.llmProvider.glm': 'GLM (Zhipu)',
  'settings.llmProvider.kimi': 'Kimi (Moonshot)',
  'settings.llmProvider.minimax': 'MiniMax',
  'settings.llmProvider.mimo': 'Mimo (Xiaomi MiMo)',
  'settings.llmProvider.ollama': 'Ollama (local)',
  'settings.llmProvider.custom': 'Custom (OpenAI-compatible)',
